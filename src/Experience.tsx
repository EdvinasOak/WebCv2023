		...
		<div className='Experience'>
			<div className='grid-container'>
				...
				<div className='descriptionItem'>
					<li>
						Developed and maintained a browser-based Contact Centre (SPA), along
						with administrative and data visualisation applications, employing
						Angular 2+, TypeScript, and SCSS. This effort resulted in creating
						applications used by thousands of agents and supervisors, offering
						exceptional user experiences, trusted, and utilized by global
						industry leaders.
					</li>
					<p />
					<li>
					...
					<li>
						Documented new features and critical project details to ensure that
						developers, testers, and other stakeholders possessed a clear
				...
				<div className='descriptionItem2'>
					...
					<li>
						...
						reviews, and task management tools like Trello, while also building
						interpersonal skills by collaborating with team members, whether
						locally or remotely, through Slack.
					</li>
				</div>
			</div>
		</div>
